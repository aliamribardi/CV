    ...
    <div class="row">
        <div class="col-md-11">
            <section class="widget">
                <div class="body">
                    <form class="no-margin" action="{{ Route('storemyWork') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <fieldset>
                            <div class="form-group">
                                <label for="name" >Name Project</label>
                                <div class="input-addon">
                                    <input id="name" type="text" name="name" class="form-control input-lg input-transparent" placeholder="Your Name Project" autofocus>
                                     @error('name')
