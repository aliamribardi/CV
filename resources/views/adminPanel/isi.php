                ...
                <table class="table table-striped table-lg mt-sm mb-0 sources-table">
                    <thead>
                        <tr>
                            ...
                            <th>Target</th>
                            <th class="chart-col-header hidden-sm hidden-xs">Trend</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            ...
                            <td>900</td>
                            <td class="chart-cell hidden-sm hidden-xs">
            ...
            <div class="body">
                <div id="chat" class="chat">
                    <div id="chat-messages" class="chat-messages">
                        ...
                        <div class="chat-message">
                            <div class="sender pull-right">
                                <div class="icon">
                                    <img src="adminPanel/img/avatars/5.png" class="img-circle" alt="">
                                </div>
                                <div class="time">
                                    3 min
                                </div>
                    ...
                    <footer class="chat-footer row">
                        ...
                        <div class="col-xs-3">
                            <button type="button" id="new-message-btn"
                                class="btn btn-transparent btn-block">Send</button>
                        </div>
                    </footer>
                </div>
            </div>
            ...
            <div class="body">
                <div id="feed" class="feed">
                    <div class="wrapper">
                        ...
                        <section class="feed-item">
                            <div class="icon pull-left">
                                <img src="adminPanel/img/avatars/1.png" class="img-circle" alt="">
                            </div>
                            <div class="feed-item-body">
                                <div class="text">
        ...
        <section class="widget widget-tabs">
            ...
            <div class="body tab-content">
                <div id="stats" class="tab-pane active clearfix">
                    <h5 class="tab-header"><span class="label label-primary"><i class="fa fa-facebook"></i></span> Last
                        logged-in users</h5>
                    <ul class="news-list">
                        <li>
                            <img src="adminPanel/img/avatars/1.png" alt="" class="pull-left img-circle" />
                        ...
                        <li>
                            <img src="adminPanel/img/avatars/2.png" alt="" class="pull-left img-circle" />
                            <div class="news-item-info">
                        ...
                        <li>
                            <img src="adminPanel/img/avatars/3.png" alt="" class="pull-left img-circle" />
                            <div class="news-item-info">
                        ...
                        <li>
                            <img src="adminPanel/img/avatars/4.png" alt="" class="pull-left img-circle" />
                            <div class="news-item-info">
                        ...
                        <li>
                            <img src="adminPanel/img/avatars/5.png" alt="" class="pull-left img-circle" />
                            <div class="news-item-info">
                ...
                <div id="report" class="tab-pane">
                    ...
                    <ul class="news-list news-list-no-hover">
                        <li>
                            <img src="adminPanel/img/avatars/6.png" alt="" class="pull-left img-circle" />
                            <div class="news-item-info">
                                <div class="name"><a href="#">Jessica Johnsson</a></div>
                                <div class="options">
                                    <button class="btn btn-xs btn-success mr-md">
                        ...
                        <li>
                            <img src="adminPanel/img/avatars/7.png" alt="" class="pull-left img-circle" />
                            <div class="news-item-info">
                                <div class="name"><a href="#">Frans Garey</a></div>
                                <div class="options">
                                    <button class="btn btn-xs btn-success mr-md">
