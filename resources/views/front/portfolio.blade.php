        ...
        <div id="portfolio-wrapper" class="bgrid-quarters s-bgrid-thirds cf">
            ...
            <div class="columns portfolio-item">
                <div class="item-wrap">
                    ...
                    <img alt="" src="{{ asset('front/images/portfolio/coffee.jpg') }}">
                    <div class="overlay">
            ...
            <div class="columns portfolio-item">
                <div class="item-wrap">
                    ...
                    <img alt="" src="{{ asset('front/images/portfolio/console.jpg') }}">
                    <div class="overlay">
                        <div class="portfolio-item-meta">
                                <h5>Console</h5>
                            <p>Web Development</p>
            ...
            <div class="columns portfolio-item">
                <div class="item-wrap">
                    ...
                    <img alt="" src="{{ asset('front/images/portfolio/judah.jpg') }}">
                    <div class="overlay">
                        <div class="portfolio-item-meta">
                                <h5>Judah</h5>
                            <p>Webdesign</p>
            ...
            <div class="columns portfolio-item">
                <div class="item-wrap">
                    ...
                    <img alt="" src="{{ asset('front/images/portfolio/into-the-light.jpg') }}">
                    <div class="overlay">
                        <div class="portfolio-item-meta">
            ...
            <div class="columns portfolio-item">
                <div class="item-wrap">
                    ...
                    <img alt="" src="{{ asset('front/images/portfolio/farmerboy.jpg') }}">
                    <div class="overlay">
                        <div class="portfolio-item-meta">
                                <h5>Farmer Boy</h5>
                            <p>Branding</p>
            ...
            <div class="columns portfolio-item">
                <div class="item-wrap">
                    ...
                    <img alt="" src="{{ asset('front/images/portfolio/girl.jpg') }}">
                    <div class="overlay">
                        <div class="portfolio-item-meta">
                                <h5>Girl</h5>
                            <p>Photography</p>
            ...
            <div class="columns portfolio-item">
                <div class="item-wrap">
                    ...
                    <img alt="" src="{{ asset('front/images/portfolio/origami.jpg') }}">
                    <div class="overlay">
                        <div class="portfolio-item-meta">
                                <h5>Origami</h5>
                            <p>Illustrration</p>
            ...
            <div class="columns portfolio-item">
                <div class="item-wrap">
                    ...
                    <img alt="" src="{{ asset('front/images/portfolio/retrocam.jpg') }}">
                    <div class="overlay">
                        <div class="portfolio-item-meta">
                                <h5>Retrocam</h5>
                            <p>Web Development</p>
